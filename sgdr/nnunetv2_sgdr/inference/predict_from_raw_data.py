...
from nnunetv2_sgdr.configuration import default_num_processes
from nnunetv2_sgdr.inference.data_iterators import PreprocessAdapterFromNpy, preprocessing_iterator_fromfiles, \
    preprocessing_iterator_fromnpy
from nnunetv2_sgdr.inference.export_prediction import export_prediction_from_logits, \
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        trainer_class = recursive_find_python_class(join(nnunetv2_sgdr.__path__[0], "training", "nnUNetTrainer"),
...
if __name__ == '__main__':
    ...
    from nnunetv2_sgdr.paths import nnUNet_results, nnUNet_raw
