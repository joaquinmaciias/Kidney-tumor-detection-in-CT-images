...
from nnunetv2_sgdr.experiment_planning.dataset_fingerprint.fingerprint_extractor import DatasetFingerprintExtractor
from nnunetv2_sgdr.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
from nnunetv2_sgdr.experiment_planning.verify_dataset_integrity import verify_dataset_integrity
from nnunetv2_sgdr.paths import nnUNet_raw, nnUNet_preprocessed
from nnunetv2_sgdr.utilities.dataset_name_id_conversion import convert_id_to_dataset_name
from nnunetv2_sgdr.utilities.find_class_by_name import recursive_find_python_class
from nnunetv2_sgdr.utilities.plans_handling.plans_handler import PlansManager
from nnunetv2_sgdr.utilities.utils import get_filenames_of_train_images_and_targets
...
def extract_fingerprints(dataset_ids: List[int], fingerprint_extractor_class_name: str = 'DatasetFingerprintExtractor',
    ...
    """
    fingerprint_extractor_class = recursive_find_python_class(join(nnunetv2_sgdr.__path__[0], "experiment_planning"),
