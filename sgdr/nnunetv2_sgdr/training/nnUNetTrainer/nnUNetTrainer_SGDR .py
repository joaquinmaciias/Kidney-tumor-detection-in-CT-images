...
from nnunetv2_sgdr.configuration import ANISO_THRESHOLD, default_num_processes
from nnunetv2_sgdr.evaluation.evaluate_predictions import compute_metrics_on_folder
from nnunetv2_sgdr.inference.export_prediction import export_prediction_from_logits, resample_and_save
from nnunetv2_sgdr.inference.predict_from_raw_data import nnUNetPredictor
from nnunetv2_sgdr.inference.sliding_window_prediction import compute_gaussian
from nnunetv2_sgdr.paths import nnUNet_preprocessed, nnUNet_results
from nnunetv2_sgdr.training.data_augmentation.compute_initial_patch_size import get_patch_size
from nnunetv2_sgdr.training.data_augmentation.custom_transforms.cascade_transforms import MoveSegAsOneHotToData, \
    ApplyRandomBinaryOperatorTransform, RemoveRandomConnectedComponentFromOneHotEncodingTransform
from nnunetv2_sgdr.training.data_augmentation.custom_transforms.deep_supervision_donwsampling import \
    DownsampleSegForDSTransform2
from nnunetv2_sgdr.training.data_augmentation.custom_transforms.limited_length_multithreaded_augmenter import \
    LimitedLenWrapper
from nnunetv2_sgdr.training.data_augmentation.custom_transforms.masking import MaskTransform
from nnunetv2_sgdr.training.data_augmentation.custom_transforms.region_based_training import \
    ConvertSegmentationToRegionsTransform
from nnunetv2_sgdr.training.data_augmentation.custom_transforms.transforms_for_dummy_2d import Convert2DTo3DTransform, \
    Convert3DTo2DTransform
from nnunetv2_sgdr.training.dataloading.data_loader_2d import nnUNetDataLoader2D
from nnunetv2_sgdr.training.dataloading.data_loader_3d import nnUNetDataLoader3D
from nnunetv2_sgdr.training.dataloading.nnunet_dataset import nnUNetDataset
from nnunetv2_sgdr.training.dataloading.utils import get_case_identifiers, unpack_dataset
from nnunetv2_sgdr.training.logging.nnunet_logger import nnUNetLogger
from nnunetv2_sgdr.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
from nnunetv2_sgdr.training.loss.deep_supervision import DeepSupervisionWrapper
from nnunetv2_sgdr.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
from nnunetv2_sgdr.training.lr_scheduler.sgdrlr import CosineAnnealingWarmRestartsLR
from nnunetv2_sgdr.utilities.collate_outputs import collate_outputs
from nnunetv2_sgdr.utilities.default_n_proc_DA import get_allowed_n_proc_DA
from nnunetv2_sgdr.utilities.file_path_utilities import check_workers_alive_and_busy
from nnunetv2_sgdr.utilities.get_network_from_plans import get_network_from_plans
from nnunetv2_sgdr.utilities.helpers import empty_cache, dummy_context
from nnunetv2_sgdr.utilities.label_handling.label_handling import convert_labelmap_to_one_hot, determine_num_input_channels
from nnunetv2_sgdr.utilities.plans_handling.plans_handler import PlansManager, ConfigurationManager
...
class nnUNetTrainer_SGDR(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda'), num_epochs:int = 1200, initial_lr:float = 1e-1, t_0:int = 10, t_mult:int = 2, eta_min = 1e-4):
    ...
    def configure_optimizers(self):
        ...
        # lr_scheduler = CosineAnnealingWarmRestartsLR(optimizer, self.initial_lr, self.T_0, self.T_mult, self.eta_min)
    ...
    def on_epoch_end(self):
        ...
        temp_epoch = current_epoch + 1
        if not (temp_epoch < 50 or (temp_epoch > 110 and temp_epoch < 170) or (temp_epoch > 210 and temp_epoch < 270) \
                            or (temp_epoch > 310 and temp_epoch < 370) or (temp_epoch > 410 and temp_epoch < 470) \
                            or (temp_epoch > 510 and temp_epoch < 570) or (temp_epoch > 610 and temp_epoch < 670)):
