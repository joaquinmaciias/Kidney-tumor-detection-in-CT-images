...
from nnunetv2_sgdr.imageio.natural_image_reader_writer import NaturalImage2DIO
from nnunetv2_sgdr.imageio.nibabel_reader_writer import NibabelIO, NibabelIOWithReorient
from nnunetv2_sgdr.imageio.simpleitk_reader_writer import SimpleITKIO
from nnunetv2_sgdr.imageio.tif_reader_writer import Tiff3DIO
...
def recursive_find_reader_writer_by_name(rw_class_name: str) -> Type[BaseReaderWriter]:
    ret = recursive_find_python_class(join(nnunetv2_sgdr.__path__[0], "imageio"), rw_class_name, 'nnunetv2.imageio')
    if ret is None:
